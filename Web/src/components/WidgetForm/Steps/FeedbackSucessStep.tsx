import { CloseButoon } from "../../CloseButoon";

interface FeedbackSucessStepProps{
  onFeedbackRestartedRequeted: () => void
}

export function FeedbackSucessStep({ 
  onFeedbackRestartedRequeted }: FeedbackSucessStepProps){
  return(
    <>
    <header>
      <CloseButoon />
    ...
    <div className="flex flex-col items-center py-10 w-[304px]">
      ...
      onClick={onFeedbackRestartedRequeted}
      >
        Quero enviar outro
      </button>
    </div>
